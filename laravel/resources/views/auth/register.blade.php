<x-layouts.app title="Join Social">
    <div class="w-full max-w-md">
        <div class="mb-6 text-center">
            <span class="mx-auto mb-3 grid size-12 place-items-center rounded-2xl bg-gradient-to-br from-indigo-500 to-fuchsia-500 text-white">
            ...
            <p class="text-sm text-gray-500">Join the conversation.</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}" class="card space-y-4 p-6"
            ...
            <div>
                ...
                <div class="mt-2">
                    ...
                    <p class="mt-1 text-xs text-gray-400" x-text="password ? level.label : ''"></p>
                </div>
            </div>
